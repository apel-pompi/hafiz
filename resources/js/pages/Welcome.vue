                ...
                <div class="flex flex-wrap items-center justify-center gap-4 md:justify-end">
                    ...
                    <div class="flex items-center border-l border-white pl-3">
                        <div class="flex space-x-4 divide-x divide-white">
                            <div class="pr-3">
                                <Facebook class="h-4 w-4 text-white transition-all duration-300 ease-in-out hover:scale-110 hover:text-orange-500" />
                            </div>
                            <div class="px-3">
                                <TwitterIcon
                            ...
                            <div class="px-3">
                                <Instagram class="h-4 w-4 text-white transition-all duration-300 ease-in-out hover:scale-110 hover:text-orange-500" />
                            </div>
                            <div class="pl-3">
                                <Linkedin class="h-4 w-4 text-white transition-all duration-300 ease-in-out hover:scale-110 hover:text-orange-500" />
                            </div>
                        </div>
                    </div>
